...
PixelOut main(VertexOut pixel_in) : SV_TARGET
{
    ...
    float3 color_out = color_base.rgb * g_base_color;
    ...
    float mip_level = ComputeMipLevel(pixel_uv * g_filter_pixel_scale); // TODO
    ...
    // TODO: calc emission
    pixel_out.emission = float4(color_out * g_emission_color, 1.0) * g_emission_intensity;
